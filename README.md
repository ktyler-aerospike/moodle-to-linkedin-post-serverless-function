...
1. Click **Done**.
1. Back on the Deploy Revision interface, go to the bottom and click **Deploy**. It will likely fail saying something like $${\color{red}The\spaceservice\spaceaccount used must be granted the 'Secret Manager Secret Accessor' role}$$
